...
from utils.util import Evaluation_leison_fun
...
# model = "predictions_GAN_mixCT_adv_cls_MMD_EpochN200_lr5.0e-4wcls_2.0wmmd0.0_DeeplySupervised_NLST_newImp_adam_1012_700_rg_nrs_100"
# model = "predictions_GAN_mixCT_adv_cls_MMD_EpochN200_lr5.0e-4wcls_2.0wmmd0.0_DeeplySupervised_NLST_newImp_adam_1012_700_rg_nrs_500_nrs_1"
...
for uid in uids:
    ...
    try:
        ...
        out_dict = Evaluation_leison_fun( mask_test, mask_truth )
    except:
...
output.to_csv('./docs/{}_Lesion_eva.csv'.format(model), encoding='utf-8')
ax = output.plot.scatter( x = 'Leisions in Reference', y = 'Leisions in Detection' )
fig = ax.get_figure()
fig.savefig('./docs/{}_leision.jpg'.format(Gtruth))
print( output.mean() )